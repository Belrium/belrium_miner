...
function main() {
  ...
  program
    ...
    .option('-d, --daemon', 'Run Belrium node as daemon')
  ...
  var pidFile = path.join(baseDir, 'bel.pid');
  if (fs.existsSync(pidFile)) {
    console.log('Failed: Belrium server already started');
    return;
  }
  ...
  if (program.daemon) {
    console.log('Belrium server started as daemon ...');
