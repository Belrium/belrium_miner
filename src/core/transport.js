...
Transport.prototype.onUnconfirmedTransaction = function (transaction, broadcast) {
  if (broadcast) {
    var data = {
      transaction: transaction//library.protobuf.encodeTransaction(transaction).toString('base64')
    };
...
Transport.prototype.onNewBlock = function (block, votes, broadcast) {
  if (broadcast) {
    var data = {
      block: block,//library.protobuf.encodeBlock(block).toString('base64'),
      votes: votes//library.protobuf.encodeBlockVotes(votes).toString('base64'),
    };
...
Transport.prototype.onNewPropose = function (propose, broadcast) {
  if (broadcast) {
    var data = {
      propose: propose //library.protobuf.encodeBlockPropose(propose).toString('base64')
    };
