...
private.generateAddressByPublicKey2 = function (publicKey) {
  if (!global.featureSwitch.enableUIA) {
    return private.getAddressByPublicKey(publicKey)
  }
  var oldAddress = private.getAddressByPublicKey(publicKey)
...
Block.prototype.dbRead = function (raw) {
  if (!raw.b_id) {
    ...
    var block = {
      ...
      generatorId: private.generateAddressByPublicKey2(raw.b_generatorPublicKey),
